export const readerAbi = [
  {
    type: "constructor",
    inputs: [{ name: "mgv", type: "address", internalType: "address" }],
    ...
    outputs: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: "binPosInLeaf", type: "uint256", internalType: "uint256" },
  ...
  },
  {
    type: "function",
    name: "openMarkets",
    inputs: [{ name: "withConfig", type: "bool", internalType: "bool" }],
    outputs: [
      {
        name: "",
        type: "tuple[]",
    ...
    outputs: [
      {
        ...
        components: [
          { name: "totalGot", type: "uint256", internalType: "uint256" },
          { name: "totalGave", type: "uint256", internalType: "uint256" },
          { name: "totalGasreq", type: "uint256", internalType: "uint256" },
        ],
      },
    ],
    stateMutability: "view",
